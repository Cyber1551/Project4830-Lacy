...
app.use(function (req, res, next) {
  res.header("Access-Control-Allow-Origin", "http://ec2-18-191-134-20.us-east-2.compute.amazonaws.com:80"); // update to match the domain you will make the request from
  res.header(
